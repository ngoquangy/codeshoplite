...
<div class = 'content'>
    ...
    <div class="grid grid-cols-12 gap-12 mt-5">
        <div class="intro-y col-span-12 lg:col-span-12">
            <!-- BEGIN: Form Layout -->
            <form method="post" action="<?php echo e(route('baihoc.store')); ?>" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <div class="intro-y box p-5">
                    <div class="mt-3">
                        <label for="regular-form-1" class="form-label">Tên bài học</label>
                        <input name="ten_bai_hoc" type="text" class="form-control" placeholder="tên bài học">
                    </div>
                    <div class="mt-3">
                    ...
                    <div class="mt-3">
                        ...
                        <select name="id_khoahoc" class="form-select mt-2">
                            <?php $__currentLoopData = $khoahoc; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($data->id); ?>"><?php echo e($data->ten_khoa_hoc); ?></option>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\CODE\laravel\shoplite\resources\views/backend/baihoc/create.blade.php ENDPATH**/ ?>